    ...
    <div class="sidebar-menu">
        ...
        <div class="sidebar-menu-inner">
            ...
            <ul id="main-menu" class="main-menu">
                ...
                <li>
                    <a href="{{route('administrator.reseller')}}" >
                        <i class="entypo-monitor"></i>
                        <span class="title">Reseller</span>
                    </a>
                </li>
                <li>
                    <a href="{{route('administrator.sub.reseller')}}" >
                        <i class="entypo-monitor"></i>
                        <span class="title">Sub-ReSeller</span>
                    </a>
                </li>
                <li>
                    <a href="{{route('administrator.freeuser')}}" >
                        <i class="entypo-monitor"></i>
                        <span class="title">Add VPN User</span>
                    </a>
                </li>
                <li>
                    <a href="{{route('administrator.create.quick.user')}}" >
                        <i class="entypo-monitor"></i>
