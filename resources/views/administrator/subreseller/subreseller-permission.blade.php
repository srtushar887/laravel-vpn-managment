...
@section('administrator-content')
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <form role="form" id="form1" action="{{route('administrator.subreseller.chnage.permision.save')}}" method="post" class="validate">
                @csrf
                <div class="form-group">
                    ...
                    <input type="hidden" name="password" value="{{$user_data->pass_rep}}">
