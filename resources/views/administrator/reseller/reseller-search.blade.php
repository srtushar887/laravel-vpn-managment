...
@section('administrator-content')
    ...
    <a href="{{route('craete.administrator.reseller')}}" class="btn btn-primary pull-left">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <table class="table table-bordered responsive">
                ...
                <tbody>
                @if(count($reseller_search) > 0)
                    @foreach($reseller_search as $resl)
                        <tr>
                            <td>{{$resl->name}}</td>
                            <td>{{$resl->user_name}}</td>
                            <td>{{ $resl->pass_rep}}</td>
                            @if(!empty($resl->administrator_id))
                            ...
                            <td>
                                ...
                                <a href="{{route('administrator.reseller.chnageper',$resl->id)}}" class="btn btn-info btn-sm btn-icon icon-left">
                        ...
                        <div class="modal fade custom-width modalfate" id="reseller-delete{{$resl->id}}">
                            <div class="modal-dialog" style="width: 60%;">
                                <form action="{{route('administrator.reseller.delete')}}" method="post">
                                    @csrf
                        ...
                        <div class="modal fade custom-width modalfate" id="sub-subreseller-block{{$resl->id}}">
                            <div class="modal-dialog" style="width: 60%;">
                                <form action="{{route('adminstrator.reseller.block')}}" method="post">
                                    @csrf
                                    <div class="modal-content">
                        ...
                        <div class="modal fade custom-width modalfate" id="sub-subreseller-unblock{{$resl->id}}">
                            <div class="modal-dialog" style="width: 60%;">
                                <form action="{{route('adminstrator.reseller.unblock')}}" method="post">
                                    @csrf
                                    <div class="modal-content">
                        ...
                        <div class="modal fade custom-width modalfate" id="sub-subreseller-add-cradit{{$resl->id}}">
                            <div class="modal-dialog" style="width: 60%;">
                                <form action="{{route('adminstrator.reseller.add.credit.bal')}}" method="post">
                                    @csrf
                                    <div class="modal-content">
