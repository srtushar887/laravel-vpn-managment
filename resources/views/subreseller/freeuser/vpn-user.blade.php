...
@section('subreseller-content')
    ...
    <a href="{{route('subreseller.create.free.user')}}" class="btn btn-primary pull-left">
        <i class="entypo-plus"></i>
        Create New
    </a>
    <div id="table-1_filter" class="dataTables_filter pull-right">
        <form action="{{route('subreseller.freeuser.search')}}" method="post">
            @csrf
            <label>Search:
            ...
            <table class="table table-bordered responsive">
                ...
                @foreach($all_free_user as $fuser)
                    <tr>
                        ...
                        @endif
                        <td>
                            <a href="{{route('subreseller.free.user.edit',$fuser->id)}}" class="btn btn-default btn-sm btn-icon icon-left" >
                    ...
                    <div class="modal fade custom-width modalfate" id="free-user-delete{{$fuser->id}}">
                        <div class="modal-dialog" style="width: 60%;">
                            <form action="{{route('subreseller.free.user.delete')}}" method="post">
                                @csrf
                    ...
                    <div class="modal fade custom-width modalfate" id="free-user-block{{$fuser->id}}">
                        <div class="modal-dialog" style="width: 60%;">
                            <form action="{{route('subreseller.free.user.block')}}" method="post">
                                @csrf
                                <div class="modal-content">
                    ...
                    <div class="modal fade custom-width modalfate" id="free-user-unblock{{$fuser->id}}">
                        <div class="modal-dialog" style="width: 60%;">
                            <form action="{{route('subreseller.free.user.unblock')}}" method="post">
                                @csrf
                                <div class="modal-content">
                    ...
                    <div class="modal fade custom-width modalfate" id="frr-user-add-cradit{{$fuser->id}}">
                        <div class="modal-dialog" style="width: 60%;">
                            <form action="{{route('subreseller.freeuser.add.credit.bal')}}" method="post">
                                @csrf
                                <div class="modal-content">
