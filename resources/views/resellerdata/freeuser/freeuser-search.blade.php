...
@section('reseller-content')
    ...
    <a href="{{route('reseller.create.free.user')}}" class="btn btn-primary pull-left">
                ...
                @if(count($user) > 0)
                    @foreach($user as $fuser)
                        <tr>
                            ...
                            @endif
                            <td>
                                <a href="{{route('reseller.free.user.edit',$fuser->id)}}" class="btn btn-default btn-sm btn-icon icon-left" >
                        ...
                        <div class="modal fade custom-width modalfate" id="free-user-delete{{$fuser->id}}">
                            <div class="modal-dialog" style="width: 60%;">
                                <form action="{{route('reseller.free.user.delete')}}" method="post">
                                    @csrf
                        ...
                        <div class="modal fade custom-width modalfate" id="free-user-block{{$fuser->id}}">
                            <div class="modal-dialog" style="width: 60%;">
                                <form action="{{route('reseller.free.user.block')}}" method="post">
                                    @csrf
                                    <div class="modal-content">
                        ...
                        <div class="modal fade custom-width modalfate" id="free-user-unblock{{$fuser->id}}">
                            <div class="modal-dialog" style="width: 60%;">
                                <form action="{{route('reseller.free.user.unblock')}}" method="post">
                                    @csrf
                                    <div class="modal-content">
                        ...
                        <div class="modal fade custom-width modalfate" id="frr-user-add-cradit{{$fuser->id}}">
                            <div class="modal-dialog" style="width: 60%;">
                                <form action="{{route('reseller.freeuser.add.credit.bal')}}" method="post">
                                    @csrf
                                    <div class="modal-content">
