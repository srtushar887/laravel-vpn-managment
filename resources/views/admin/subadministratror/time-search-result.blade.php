...
@section('admin-content')
    ...
    <div id="table-1_filter" class="dataTables_filter pull-right">
        <form action="{{route('admin.subadmin.time.search')}}" method="post">
            @csrf
            <label>Search:
                ...
                @foreach($sub_ad_time as $alsuba)
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{route('sub.admin.timedur',$alsuba->id)}}" class="btn btn-default btn-sm btn-icon icon-left" >
